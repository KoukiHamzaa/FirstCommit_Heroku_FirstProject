...
wp.customize( 'vmagazine_footer_btm_bg_color', function( value ) {
		value.bind( function( to ) {
			$( '.site-footer.footer-three .footer-credit,footer .buttom-footer.footer_one .footer-btm-wrap,.site-footer.footer-4 .footer-credit' ).css('background-color', to );
		});
});
