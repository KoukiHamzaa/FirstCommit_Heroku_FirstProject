	...
	class Vmagazine_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'changelog' => esc_html__('ChangeLog', 'vmagazine'),
			...
			public function welcome_admin_notice_display() {
				...
				if( is_admin() && ('themes.php' == $pagenow) && (isset($_GET['activated'])) ) {
					...
					<div class="updated apwelcome-an notice notice-success is-dismissible">
						<h2><?php printf(__( 'Welcome!', 'vmagazine' )) ?></h2>
						<p class="about-desc"><?php printf(esc_html__( 'Thank you for installing %1$s. It is now installed and ready to use. Here are some useful links to get started: ', 'vmagazine' ), $this->theme_name);  ?></p>
						<hr/>
						<div class="apwelcome-column-wrap">
							<div class="apwelcome-column col-img">
								<picture>
									<img src="<?php echo esc_url( get_template_directory_uri() . '/inc/welcome/css/demos.gif' ); ?>">
								</picture>
							</div>
							<div class="apwelcome-column col-demos">
								<div>
									<h3>
										...
										<?php printf(__( 'Starter site demos!', 'vmagazine' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'You\'ve  got 9 choices of great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'vmagazine' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page#demo_import' )  ); ?></p>
								</div>
								<div>
									<div class="notice-btn-wrapper"><a class="nav-tab demo_import button" href="<?php echo admin_url( 'themes.php?page=welcome-page#demo_import' ) ?>"><?php esc_html_e( 'ready to use starter sites.', 'vmagazine' ); ?></a></div>

									<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'vmagazine' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?>

									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'vmagazine' ); ?></p>
									<a href="https://accesspressthemes.com/support/" class=" ti-return-dashboard  button button-secondary  install-now" ><span><?php esc_html_e( 'Contact Support', 'vmagazine' ); ?></span></a>
							...
							<div class="apwelcome-column col-doc">
								<div>
									<h3>
										...
										<?php printf(__( 'Documentation', 'vmagazine' )) ?>
									</h3>
									<p><?php printf( wp_kses_post( 'How to use %1$s! Here we\'ve a full and detailed documentation that explains how to use %1$s in its best. ', 'vmagazine' ), $this->theme_name  ); ?></p>
									<a href="<?php echo esc_url($this->strings['doc_link']);?>" class=" button" ><span><?php esc_html_e( 'Full Documentation', 'vmagazine' ); ?></span></a>

								</div>
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'vmagazine' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Join in our social networks!','vmagazine') ?></h4>
											<p><?php echo esc_html__('Get connected, share your opinions and more via our social community: ', 'vmagazine'); ?></p>

											<p><a href="https://www.facebook.com/AccessPressThemes"><?php echo esc_html('Join our Facebook Group','vmagazine') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'vmagazine'); ?></p>

											<p><a href="https://www.youtube.com/channel/UCzD8I1moKISXDjAVr8dIf-w"><?php echo esc_html('Subscribe our YouTube Channel','vmagazine') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'vmagazine'); ?></p>

											<p><a href="https://twitter.com/apthemes"><?php echo esc_html('Follow us on Twitter','vmagazine') ?></a><?php echo esc_html__(' -to stay updated. ', 'vmagazine'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											<h4><?php echo esc_html('Rate us!','vmagazine') ?></h4>
											<p><?php  printf(esc_html__('Are you enjoying %1$s? We would love to hear your feedback!', 'vmagazine'),$this->theme_name); ?></p>
											<a href="https://themeforest.net/downloads"><?php echo esc_html('Write a review','vmagazine') ?></a>
