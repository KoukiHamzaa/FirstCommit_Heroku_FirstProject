...
if( $vmagazine_preloader_color ){
    ...
    *
    */
    $vmagazine_cat_layouts = get_theme_mod('vmagazine_cat_layouts','cat-style-1');
    if( $vmagazine_cat_layouts == 'cat-style-1' ){
...
if( $vmagazine_mobile_header_bg ){
    ...
    */
    ...
    $vmagazine_footer_btm_bg_color = get_theme_mod('vmagazine_footer_btm_bg_color','#151515');
    ...
    if( $vmagazine_footer_btm_bg_color != '#151515'){
        $custom_css .= "
            .site-footer.footer-three .footer-credit,footer .buttom-footer.footer_one .footer-btm-wrap{
                background-color: {$vmagazine_footer_btm_bg_color};
            }
        }";
    }
