...
function vmagazine_button_footer(){
    ...
    switch ( $vmagazine_footer_layout ) {
        ...
        case 'footer_layout_3':
            get_template_part( 'layouts/footer/footer', 'layout3' );
            break;
       ...
       $vmagazine_cat_layouts = get_theme_mod('vmagazine_cat_layouts','cat-style-1');
        ...
        if ( 'post' === get_post_type() ) {
                ...
                if( $categories ) {
                    ...
                    if( $vmagazine_cat_layouts == 'cat-style-2' ){
                        $cat_link = get_category_link( $categories[0]->term_id );
                        $output .= '<a href="'.$cat_link.'" class="cat-' . $categories[0]->term_id . '" rel="category tag">'.$categories[0]->cat_name.'</a>';
                    }else{
