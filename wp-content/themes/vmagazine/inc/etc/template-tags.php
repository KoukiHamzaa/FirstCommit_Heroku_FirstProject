...
if( ! function_exists( 'vmagazine_icon_meta') ){
    function vmagazine_icon_meta(){
	    ...
	    $vmagazine_enable_post_meta = get_theme_mod('vmagazine_enable_post_meta','show');
	    $vmagazine_enable_post_date = get_theme_mod('vmagazine_enable_post_date','show');
	    $vmagazine_enable_post_comments = get_theme_mod('vmagazine_enable_post_comments','show');
	    $vmagazine_enable_post_view = get_theme_mod('vmagazine_enable_post_view','show');


	    if( 'hide' == $vmagazine_enable_post_meta ){
	    	return;
	    }
	   
	   	if( 'show' == $vmagazine_enable_post_date ){
	    	echo '<span class="posted-on"><i class="fa fa-clock-o"></i>'. esc_html($posted_on) .'</span>';
		}

	   	if( 'show' == $vmagazine_enable_post_comments ){
	    	echo '<span class="comments"><i class="fa fa-comments"></i>'. esc_html($comments) .'</span>';
		}

	   	if( 'show' == $vmagazine_enable_post_view ){
