...
$(document).on('change','.components-select-control__input', function(){
    var currentVal = $(this).val();
    $('#pg-metabox-format .meta-row .meta-options').children('.format-type-field').hide();
    $('#pg-metabox-format .meta-row .meta-options').children('#format-'+currentVal).show();
});

$(window).on('load', function() {
    var defaultVal = $('select[class="components-select-control__input"] option:selected').attr('value')
   $('#pg-metabox-format .meta-row .meta-options').children('#format-'+defaultVal).show(); 
});
