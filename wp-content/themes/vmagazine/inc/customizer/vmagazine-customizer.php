...
/**
* Category layout stles
* @since 1.1.5
*/
$wp_customize->add_setting( 'vmagazine_cat_layout_seperator', array(
  'sanitize_callback' => 'vmagazine_sanitize_text',
) );

$wp_customize->add_control( new Wp_Customize_Seperator_Control( $wp_customize, 'vmagazine_cat_layout_seperator',  array(
  'label'     => esc_html__( 'Category Layouts', 'vmagazine' ),
  'section'   => 'vmagazine_general_options',
) ) ); 

$wp_customize->add_setting('vmagazine_cat_layouts', array(
          'default'           => 'cat-style-1',
          'sanitize_callback' => 'sanitize_text_field'
        )
      );
$wp_customize->add_control('vmagazine_cat_layouts',array(
    'section'      => 'vmagazine_general_options',
    'type'         => 'select',
    'label'        => esc_html__( 'Choose Template', 'vmagazine' ),
    'description'  => esc_html__( 'Choose styles for category', 'vmagazine' ),
    'choices'      => array(
      'cat-style-1'   => esc_html__('Style One','vmagazine'),
      'cat-style-2'    => esc_html__('Style Two','vmagazine'),
    )
  )
);

/**
* Post Meta control options
* @since 1.1.5
*/
$wp_customize->add_setting( 'vmagazine_post_meta_seperator', array(
  'sanitize_callback' => 'vmagazine_sanitize_text',
) );

$wp_customize->add_control( new Wp_Customize_Seperator_Control( $wp_customize, 'vmagazine_post_meta_seperator',  array(
  'label'     => esc_html__( 'Post Meta Options', 'vmagazine' ),
  'section'   => 'vmagazine_general_options',
) ) ); 

//show or hide post meta
$wp_customize->add_setting( 'vmagazine_enable_post_meta',array(
        'default'           => 'show',
        'sanitize_callback' => 'vmagazine_sanitize_switch_option',
    )
);
$wp_customize->add_control( new Vmagazine_Customize_Switch_Control($wp_customize, 'vmagazine_enable_post_meta',
        array(
            'type'        => 'switch',
            'label'       => esc_html__( 'Show Or Hide Post Meta', 'vmagazine' ),
            'description' => esc_html__( 'Show or hide post meta from whole site.', 'vmagazine' ),
            'section'     => 'vmagazine_general_options',
            'choices'     => array(
                'show'    => esc_html__( 'Show', 'vmagazine' ),
                'hide'    => esc_html__( 'Hide', 'vmagazine' )
...
//post date show or hide
$wp_customize->add_setting( 'vmagazine_enable_post_date',array(
        'default'           => 'show',
        'sanitize_callback' => 'vmagazine_sanitize_switch_option',
    )
);
$wp_customize->add_control( new Vmagazine_Customize_Switch_Control($wp_customize, 'vmagazine_enable_post_date',
        array(
            'type'        => 'switch',
            'label'       => esc_html__( 'Show Or Hide Post Date', 'vmagazine' ),
            'description' => esc_html__( 'Show or hide post date from whole site.', 'vmagazine' ),
            'section'     => 'vmagazine_general_options',
            'active_callback' => 'vmagazine_post_meta_callback',
            'choices'     => array(
                'show'    => esc_html__( 'Show', 'vmagazine' ),
                'hide'    => esc_html__( 'Hide', 'vmagazine' )
            ),
...
//post comment show or hide
$wp_customize->add_setting( 'vmagazine_enable_post_comments',array(
        'default'           => 'show',
        'sanitize_callback' => 'vmagazine_sanitize_switch_option',
    )
);
$wp_customize->add_control( new Vmagazine_Customize_Switch_Control($wp_customize, 'vmagazine_enable_post_comments',
        array(
            'type'        => 'switch',
            'label'       => esc_html__( 'Show Or Hide Post Comment Count', 'vmagazine' ),
            'description' => esc_html__( 'Show or hide post comment count from whole site.', 'vmagazine' ),
            'section'     => 'vmagazine_general_options',
            'active_callback' => 'vmagazine_post_meta_callback',
            'choices'     => array(
                'show'    => esc_html__( 'Show', 'vmagazine' ),
...
//post view show or hide
$wp_customize->add_setting( 'vmagazine_enable_post_view',array(
        'default'           => 'show',
        'sanitize_callback' => 'vmagazine_sanitize_switch_option',
    )
);
$wp_customize->add_control( new Vmagazine_Customize_Switch_Control($wp_customize, 'vmagazine_enable_post_view',
        array(
            'type'        => 'switch',
            'label'       => esc_html__( 'Show Or Hide Post View Count', 'vmagazine' ),
            'description' => esc_html__( 'Show or hide post view count from whole site.', 'vmagazine' ),
            'section'     => 'vmagazine_general_options',
            'active_callback' => 'vmagazine_post_meta_callback',
            'choices'     => array(
                'show'    => esc_html__( 'Show', 'vmagazine' ),
...
* @since 1.1.7
*/
$wp_customize->add_section( 'vmagazine_api_conf', array(
  'title'           => esc_html__('API Configurations', 'vmagazine'),
  'panel'           => 'general_settings'
));


$wp_customize->add_setting( 'vmagazine_yt_api', array(
        'sanitize_callback' => 'vmagazine_sanitize_text'                  
    )
);    
$wp_customize->add_control( 'vmagazine_yt_api', array(
        'type'            => 'text',
        'label'           => esc_html__( 'YouTube API', 'vmagazine' ),
        'description'     => esc_html__('Add your API Key to use YouTube video playlist you can generate API from https://console.developers.google.com/','vmagazine'),
        'section'         => 'vmagazine_api_conf',
        'priority'        => 10
    )
);
...
$wp_customize->add_setting('vmagazine_footer_btm_bg_color', array(
        'default'           => '#151515',
        'sanitize_callback' => 'sanitize_hex_color',
        'transport'         => 'postMessage'
...
$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize,'vmagazine_footer_btm_bg_color', array(
            'label'         => esc_html__( 'Bottom Footer Background Color', 'vmagazine' ),
            'section'       => 'vmagazine_footer_options',
)));
...
$wp_customize->add_control('vmagazine_footer_layout', array(
    ...
    'priority'  	  => 2,
        ...
        'footer_layout_3' => esc_html__( 'Footer Layout 3', 'vmagazine' ),
    		)
    )
); 	    
...
*
*/
$wp_customize->add_setting( 'vmagazine_footer_icon_title',  array(
        'default'             => esc_html__( 'Follow Us Today!', 'vmagazine' ),
        'sanitize_callback'   => 'vmagazine_sanitize_text'
    ) );    
$wp_customize->add_control( 'vmagazine_footer_icon_title', array(
        'type'      => 'text',
        'label'     => esc_html__( 'Icon Title', 'vmagazine' ),
        'section'   => 'vmagazine_footer_options',
