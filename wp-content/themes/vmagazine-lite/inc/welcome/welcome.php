	...
	class Vmagazine_Lite_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Recommended Plugins', 'vmagazine-lite'),
						...
						<div class="apwelcome-column-wrap">
							...
							<div class="apwelcome-column col-demos">
								<div>
									...
									<p><?php printf( wp_kses_post( 'You\'ve  got 5 choices of great starter sites (Demos) to start with. By using one of these starter sites you\'ll get a great guidance on how to use the theme to its fullest and also save time to make your website. ', 'vmagazine-lite' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page#demo_import' )  ); ?></p>
								</div>
								<div>
									<div class="button-wrapper">
										<a class="button button-primary button-hero install-now" href="<?php echo esc_url(admin_url('themes.php?page=welcome-page#demo_import' )) ?>"><?php esc_html_e( 'ready to use starter sites.', 'vmagazine-lite' ); ?></a>
										<?php printf( wp_kses_post( '<a class="options-page-btn button-secondary" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'vmagazine-lite' ), $this->theme_name, admin_url( 'themes.php?page=welcome-page' )  ); ?>
									</div>
				...
				<div class="wrap about-wrap access-wrap">
					<div class="top-block-wrap">
						<div class="about-text">
							<h1><?php printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'vmagazine-lite' ), $this->theme_name, $this->theme_version ); ?></h1>
								...
								<div class="welcome-section-wrapper is_loading">
									...
									<div class="notice-sidebar is_loading">
										<div class= "notice-sidebar-item">
											...
											<p><a href="<?php echo esc_url('https://www.facebook.com/AccessPressThemes')?>"><?php echo esc_html('Join our Facebook Group','vmagazine-lite') ?></a><?php echo esc_html__(' -to receive updates, offers and more.', 'vmagazine-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://www.youtube.com/user/accesspressthemes')?>"><?php echo esc_html('Subscribe our YouTube Channel','vmagazine-lite') ?></a><?php echo esc_html__(' -for tutorials, videos and more.', 'vmagazine-lite'); ?></p>

											<p><a href="<?php echo esc_url('https://twitter.com/apthemes')?>"><?php echo esc_html('Follow us on Twitter','vmagazine-lite') ?></a><?php echo esc_html__(' -to stay updated. ', 'vmagazine-lite'); ?></p>
										</div>
										<div class= "notice-sidebar-item">
											...
											<a href="<?php echo esc_url('https://wordpress.org/support/theme/vmagazine-lite/reviews/#new-post')?>"><?php echo esc_html('Write a review','vmagazine-lite') ?></a>
