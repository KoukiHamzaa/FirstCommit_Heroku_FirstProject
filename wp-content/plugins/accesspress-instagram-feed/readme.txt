...
* <strong>Fetch Feeds Of Your Instagram from any account using Instagram API</strong>
...
= 3.1.3 =
* Updated isotope library files
* Checked Nonce on post data.
* Fixed Issues to get Instagram access token key.
