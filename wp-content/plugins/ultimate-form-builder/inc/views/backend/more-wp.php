<div class="wrap">
    ...
    <h3><?php _e( 'More WordPress Resources', UFB_TD ); ?></h3>

    <div class="ufb-content-wrap">
     <div>
           <p><strong>Ultimate Form Builder</strong> works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
