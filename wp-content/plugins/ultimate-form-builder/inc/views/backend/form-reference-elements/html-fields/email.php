<div class="ufb-email-reference">
    <div class="ufb-each-form-field ufb-relative">
        ...
        <div class="ufb-form-field-wrap">
            <label class="ufb-field-label-ref"><?php _e( 'Untitled Email', UFB_TD ); ?></label>
        ...
        <div class="ufb-field-settings-wrap" style="display:none;">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][field_label]" placeholder="<?php _e( 'Your Email', UFB_TD ); ?>" class="ufb-field-label-field" data-field-name="ufb_key" data-field-type="field_label"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][placeholder]" placeholder='<?php _e( 'Your Email here', UFB_TD ); ?>' data-field-name="ufb_key" data-field-type="placeholder"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
            ...
            <div class="ufb-form-field-wrap">
                ...
                <div class="ufb-form-field">
                    <input type="text" name="field_data[ufb_key][field_class]" data-field-name="ufb_key" data-field-type="field_type"/>
                </div>
            </div>
            <div class="ufb-form-field-wrap">
                <label>
            ...
            <input type="hidden" name="field_data[ufb_key][field_type]" value="email" data-field-name="ufb_key" data-field-type="field_type"/>
        </div>
