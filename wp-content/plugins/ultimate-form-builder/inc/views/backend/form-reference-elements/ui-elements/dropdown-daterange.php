<div class="ufb-dropdown-daterange-reference">
    <div class="ufb-each-form-field ufb-relative">
        ...
        <div class="ufb-form-field-wrap">
            <label class="ufb-field-label-ref"><?php _e( 'Untitled Date Range', UFB_TD ); ?></label>
            <div class="ufb-form-field ufb-dropdown-date-demo">
                <div class="ufb-dropdown-daterange-wrap">
                    <span><?php _e( 'From', UFB_TD ); ?>:</span>
        ...
        <div class="ufb-field-settings-wrap" style="display:none;">
            ...
            <input type="hidden" name="field_data[ufb_key][field_type]" value="dropdown-daterange"/>
        </div>
