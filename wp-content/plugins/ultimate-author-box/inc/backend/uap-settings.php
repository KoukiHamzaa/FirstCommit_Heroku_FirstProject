...
<!-- 			    	<div class="uap-show-authorbox-small-device uab-content-wrapper">
			...
			<div id="tab-3" class="uab-tab-content">
						...
						<div class="select-tab-wrapper uab-content-wrapper">
							...
							<div>
								<select class="uab-select-input-1 uab-template-select"  name="uab_template">
									...
									<option  value="uab-template-1" <?php if ( $uab_general_settings['uab_template']=='uab-template-1' ) echo 'selected'; ?>><?php _e( 'Template 1', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-2" <?php if ( $uab_general_settings['uab_template']=='uab-template-2' ) echo 'selected'; ?>><?php _e( 'Template 2', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-3" <?php if ( $uab_general_settings['uab_template']=='uab-template-3' ) echo 'selected'; ?>><?php _e( 'Template 3', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-4" <?php if ( $uab_general_settings['uab_template']=='uab-template-4' ) echo 'selected'; ?>><?php _e( 'Template 4', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-5" <?php if ( $uab_general_settings['uab_template']=='uab-template-5' ) echo 'selected'; ?>><?php _e( 'Template 5', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-6" <?php if ( $uab_general_settings['uab_template']=='uab-template-6' ) echo 'selected'; ?>><?php _e( 'Template 6', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-7" <?php if ( $uab_general_settings['uab_template']=='uab-template-7' ) echo 'selected'; ?>><?php _e( 'Template 7', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-8" <?php if ( $uab_general_settings['uab_template']=='uab-template-8' ) echo 'selected'; ?>><?php _e( 'Template 8', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-9" <?php if ( $uab_general_settings['uab_template']=='uab-template-9' ) echo 'selected'; ?>><?php _e( 'Template 9', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-10" <?php if ( $uab_general_settings['uab_template']=='uab-template-10' ) echo 'selected'; ?>><?php _e( 'Template 10', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-11" <?php if ( $uab_general_settings['uab_template']=='uab-template-11' ) echo 'selected'; ?>><?php _e( 'Template 11', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-12" <?php if ( $uab_general_settings['uab_template']=='uab-template-12' ) echo 'selected'; ?>><?php _e( 'Template 12', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-13" <?php if ( $uab_general_settings['uab_template']=='uab-template-13' ) echo 'selected'; ?>><?php _e( 'Template 13', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-14" <?php if ( $uab_general_settings['uab_template']=='uab-template-14' ) echo 'selected'; ?>><?php _e( 'Template 14', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-15" <?php if ( $uab_general_settings['uab_template']=='uab-template-15' ) echo 'selected'; ?>><?php _e( 'Template 15', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-16" <?php if ( $uab_general_settings['uab_template']=='uab-template-16' ) echo 'selected'; ?>><?php _e( 'Template 16', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-17" <?php if ( $uab_general_settings['uab_template']=='uab-template-17' ) echo 'selected'; ?>><?php _e( 'Template 17', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-18" <?php if ( $uab_general_settings['uab_template']=='uab-template-18' ) echo 'selected'; ?>><?php _e( 'Template 18', 'ultimate-author-box' ); ?></option>
									<option  value="uab-template-19" <?php if ( $uab_general_settings['uab_template']=='uab-template-19' ) echo 'selected'; ?>><?php _e( 'Template 19', 'ultimate-author-box' ); ?></option>
									<optgroup label="<?php _e( 'Custom template', 'ultimate-author-box' ); ?>"></optgroup>
									<option  value="uab-custom-template" <?php if ( $uab_general_settings['uab_template']=='uab-custom-template' ) echo 'selected'; ?>><?php _e( 'Custom Template', 'ultimate-author-box' ); ?></option>
				...
				<div class="uab-customize-settings-content-wrapper">
					<div class="uab-content-wrapper">
						<div class="uab-label-info-wrap">
							<label><?php _e( 'Enable Custom CSS Section', 'ultimate-author-box' ); ?></label>
							<span class="uab-info"><?php _e( 'Check to Enable Custom CSS Section', 'ultimate-author-box' ); ?></span>
						</div>
						<div class="uab-slide-checkbox-wrapper">
							<div class="uab-slide-checkbox-wrapper-inner">
								<div class="uab-slide-checkbox">  
