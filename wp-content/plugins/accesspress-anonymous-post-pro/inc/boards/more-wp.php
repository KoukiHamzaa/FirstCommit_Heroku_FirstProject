<div class="ap-tabs-board" id="board-morewp-settings" style="display: none;">
	<h2><?php _e('More WordPress Resources','anonymous-post-pro');?></h2>
	<div class="ap-tab-wrapper">
        <div>
           <p><strong>AccessPress Anonymous Post PRO</strong> works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
