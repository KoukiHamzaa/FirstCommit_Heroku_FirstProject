...
class vmagazine_about_author extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'vmagazine_about_author', esc_html__('Vmagazine : About Author','vmagazine-companion'), array(
                'description' => esc_html__('A widget that shows information of a author', 'vmagazine-companion')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'widget_title' => array(
                ...
                'vmagazine_widgets_title' => esc_html__('Widget Title', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
            'author_title' => array(
                'vmagazine_widgets_name' => 'author_title',
                'vmagazine_widgets_title' => esc_html__('Author Title', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
            'author_image' => array(
                'vmagazine_widgets_name' => 'author_image',
                'vmagazine_widgets_title' => esc_html__( 'Author Image', 'vmagazine-companion' ),
                'vmagazine_widgets_field_type' => 'upload',
            ),
            'author_desc' => array(
                'vmagazine_widgets_name' => 'author_desc',
                'vmagazine_widgets_title' => esc_html__('Description', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'textarea',
            ),
            'fb_url' => array(
                'vmagazine_widgets_name' => 'fb_url',
                'vmagazine_widgets_title' => esc_html__('Facebook URL', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'url',
            ),
            'twitter_url' => array(
                'vmagazine_widgets_name' => 'twitter_url',
                'vmagazine_widgets_title' => esc_html__('Twitter URL', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'url',
            ),
            'pinterest_url' => array(
                'vmagazine_widgets_name' => 'pinterest_url',
                'vmagazine_widgets_title' => esc_html__('Pinterest URL', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'url',
            ),
            'insta_url' => array(
                'vmagazine_widgets_name' => 'insta_url',
                'vmagazine_widgets_title' => esc_html__('Instagram URL', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'url',
            ),
            'link_new_tabs' => array(
                'vmagazine_widgets_name' => 'link_new_tabs',
                'vmagazine_widgets_title' => esc_html__('Open Link on new tabs ?', 'vmagazine-companion'),
