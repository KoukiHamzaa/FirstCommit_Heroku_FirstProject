...
class vmagazine_video_player extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => __( 'Plays Youtube video in a playlist.', 'vmagazine-companion' )
        );
        parent::__construct( 'vmagazine_video_player', esc_html__( 'Vmagazine : Youtube Video Playlists', 'vmagazine-companion' ), $widget_ops );
    }
        ...
        $fields = array(
          ...
          'block_layout' => array(
            ...
            'player_video_id' => array(
                ...
                'vmagazine_widgets_title'        => esc_html__( 'Enter Youtube Video IDs', 'vmagazine-companion' ),
                'vmagazine_widgets_description'  => esc_html__( 'Id must be seperated with comma Eg: fiTaCplx0RY,BRjMNGMOV4A', 'vmagazine-companion' ),
            ...
            <div class="video-controls">
                ...
                <div class="video-track">
                    <div class="video-current-playlist">
                        <?php _e( 'Fetching Video Title..', 'vmagazine-companion' ) ?>
                    </div>

                    <div class="video-duration-time">
                        <span class="video-current-time">0:00</span>
                        /
                        <span class="video-duration"><?php esc_html_e( 'Loading..', 'vmagazine-companion' ) ?></span>     
                    </div>
                </div>
                ...
                foreach ( $video_list as $video ) {
                    ...
                    if ( is_array( $video_api_array ) && !empty( $video_api_array[ 'items' ] ) ) {
                        ...
                        <div class="vmagazine-video-list clearfix" data-index="<?php echo absint($i); ?>">  
                            <div class="video-title-duration">
                                <h6><i><?php esc_html_e( 'Either this video has been removed or you don\'t have access to watch this video', 'vmagazine-companion' ); ?></i></h6>
                            </div>
                        </div>
                        <?php
                    }
