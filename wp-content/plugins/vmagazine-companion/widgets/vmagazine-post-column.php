...
class vmagazine_block_posts_column extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct( 'vmagazine_block_posts_column', esc_html__( 'Vmagazine : Block Posts(Column)', 'vmagazine-companion' ), $widget_ops,$width );
    }
        ...
        $fields = array(
            ...
            'block_wrapper_start' => array(
                ...
                'block_column_layout' => array(
                    ...
                    'vmagazine_widgets_title' => esc_html__( 'Block Column Layouts', 'vmagazine-companion' ),
                    'vmagazine_widgets_description' => esc_html__( 'Choose the column layout from available options.', 'vmagazine-companion' ),
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'block_section_excerpt' => array(
                        ...
                        'vmagazine_widgets_description' => esc_html__( 'Enter excerpts in number of letters or leave it blank to hide default: 180 &#40; this will work on first layout only &#41;', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'number',
                        'vmagazine_widgets_default'  => 180
                    ),
                     'block_view_all_text' => array(
                        'vmagazine_widgets_name' => 'block_view_all_text',
                        'vmagazine_widgets_title' => esc_html__( 'View All Text', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'text',
                    ),
