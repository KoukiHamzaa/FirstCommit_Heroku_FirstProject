...
class vmagazine_player extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'description' => esc_html__('Add any media and to your website', 'vmagazine-companion')
                )
        );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'player_url' => array(
                ...
                'vmagazine_widgets_title' => esc_html__('Player Link', 'vmagazine-companion'),
                'vmagazine_widgets_description' => esc_html__( 'Enter soundcloud url', 'vmagazine-companion' ),
