...
class vmagazine_categories_tabbed extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display category post in tabbed.', 'vmagazine-companion' )
        );
        $width = array(
                'width'  => 600
        );
        parent::__construct( 'vmagazine_categories_tabbed', esc_html__( 'Vmagazine : Categories Tabbed', 'vmagazine-companion' ), $widget_ops,$width );
    }
               ...
               'block_title' => array(
                ...
                'block_tab_control' => array(
                    ...
                    'vmagazine_widgets_field_options'   => array(
                        'vmagazine_widget_general' => esc_html__('First Tab','vmagazine-companion'),
                        'vmagazine_widget_advanced'=> esc_html__('Second Tab','vmagazine-companion'),
                        'vmagazine_widget_third'=> esc_html__('Third Tab','vmagazine-companion'),
                        'vmagazine_widget_additionals' => esc_html__('Additional Settings','vmagazine-companion'),
                    )
                ),
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'first_tab_title' => array(
                        ...
                        'vmagazine_widgets_title'        => esc_html__( 'Tab Title', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type'   => 'text'
                    ),

                    'first_tab_category' => array(
                        'vmagazine_widgets_name' => 'first_tab_category',
                        'vmagazine_widgets_title' => esc_html__( 'Select Category for First Tab', 'vmagazine-companion' ),
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'second_tab_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Select Category for Second Tab', 'vmagazine-companion' ),
                        'vmagazine_widgets_default'      => 0,
                        'vmagazine_widgets_field_type' => 'select',
                        'vmagazine_widgets_field_options' => $vmagazine_cat_dropdown
                    ),
                ...
                //third tab settings wrapper
                    ...
                    'third_tab_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Select Category for Third Tab', 'vmagazine-companion' ),
                        'vmagazine_widgets_default'      => 0,
                        'vmagazine_widgets_field_type' => 'select',
                        'vmagazine_widgets_field_options' => $vmagazine_cat_dropdown
                    ),
                ...
                'tab_wrapper_add_start' => array(
                    ...
                    'block_button_viewall' => array(
                        ...
                        'vmagazine_widgets_title'        => esc_html__( 'Enter View All Button Text', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type'   => 'text'
                    ),
