...
class vmagazine_block_posts_ajax extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => esc_html__( 'Display posts from selected category or latest.', 'vmagazine-companion' )
        );
        $width = array(
                'width'  => 600
        );
        parent::__construct( 'vmagazine_block_posts_ajax', esc_html__( 'Vmagazine : Multiple Category Block', 'vmagazine-companion' ), $widget_ops, $width );
    }
            ...
            'block_wrapper_start' => array(
                ...
                'vmagazine_widgets_field_type'   => 'section_wrapper_start'
                 ...
                 'block_ajax_layout' => array(
                    ...
                    'vmagazine_widgets_title' => esc_html__( 'Available Layouts', 'vmagazine-companion' ),
                    'vmagazine_widgets_description' => esc_html__( 'Choose layout from available options.', 'vmagazine-companion' ),
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'block_section_excerpt' => array(
                        ...
                        'vmagazine_widgets_description' => esc_html__( 'Enter excerpts in number of letters default: 200 &#40; this will only work on first layout &#41;', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'number',
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'block_section_tab_color' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Tab Text Color', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'color'
                    ),
                    'block_section_tab_color_active' => array(
                        'vmagazine_widgets_name' => 'block_section_tab_color_active',
                        'vmagazine_widgets_title' => esc_html__( 'Tab Text Color: Active', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'color'
                    ),
            ...
            <div class="block-header clearfix">
                <?php
                    ...
                    foreach ( $vmagazine_block_multi_cats as $key => $term_id ) {
                        ...
                        if(!empty( $term )){
                            echo '<li'.$li_class.'>
                            <a href="javascript:void(0)" data-meta="'.esc_attr($block_section_meta).'" data-id="' . intval($key) . '" data-slug="' . intval($key) . '" data-link="'.get_term_link($term->slug, 'category').'" data-layout="'.esc_attr($vmagazine_block_layout).'" data-count="'.absint($vmagazine_block_posts_count).'" data-length="'.absint($block_section_excerpt).'" data-btn="'.esc_attr($block_view_all_text).'">' . $term->name . '</a>
                            </li>';
