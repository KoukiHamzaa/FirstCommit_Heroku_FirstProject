...
class vmagazine_cat_tabbed_ajax extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => __( 'Display posts from selected category as tabbed sytles.', 'vmagazine-companion' )
        );
        $width = array(
                'width'  => 600
        );
        parent::__construct( 'vmagazine_cat_tabbed_ajax', esc_html__( 'Vmagazine : Multiple Category Tabbed', 'vmagazine-companion' ), $widget_ops, $width );
    }
             ...
             'block_layout' => array(
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'block_multi_cats' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Multiple categories', 'vmagazine-companion' ),
                    ...
                    'block_section_excerpt' => array(
                        ...
                        'vmagazine_widgets_description' => esc_html__( 'Enter Excerpts in number of letters default: 200', 'vmagazine-companion' ),
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'block_section_meta' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Hide/Show Meta Description', 'vmagazine-companion' ),
            ...
            <div class="block-header clearfix">
                <?php
                    ...
                    foreach ( $vmagazine_block_multi_cats as $key => $term_id ) {
                        ...
                        if(!empty( $term )){
                            echo '<li>
                            <a href="javascript:void(0)" data-meta="'.esc_attr($block_section_meta).'" data-id="' . intval( $key ) . '" data-slug="' . intval($key) . '" data-link="'.get_term_link($term->slug, 'category').'" data-count="'.absint($block_section_excerpt).'">' . $term->name . '</a>
                            </li>';
