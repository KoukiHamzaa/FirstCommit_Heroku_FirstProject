...
class vmagazine_featured_slider extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
                'vmagazine_featured_slider', esc_html__( 'Vmagazine : Featured Slider', 'vmagazine-companion' ), array(
                'description' => esc_html__( 'Widget to control slider and featured posts section.', 'vmagazine-companion' )   
                ),$width 
        );
    }
            ...
            'block_wrapper_start' => array(
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'slider_section_header' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Slider Section', 'vmagazine-companion' ),
                    ...
                    'vmagazine_slider_post_type' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Slider Display Type', 'vmagazine-companion' ),
                    ...
                    'vmagazine_slider_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Category for Slider', 'vmagazine-companion' ),
                    ...
                    'vmagazine_slide_count' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'No of slides', 'vmagazine-companion' ),
                    ...
                    'block_posts_offset' => array(
                        ...
                        'vmagazine_widgets_title'        => esc_html__( 'Offset Value', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type'   => 'number'
                    ),
                    ...
                    'featured_section_header' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Featured Posts Section', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'section_header'
                    ),

                    'featured_section_option' => array(
                        'vmagazine_widgets_name' => 'featured_section_option',
                        'vmagazine_widgets_title' => esc_html__( 'Show/Hide Featured Section', 'vmagazine-companion' ),
                        ...
                        'vmagazine_widgets_description'  => esc_html__('Show or hide featured section below slider','vmagazine-companion'),
                    ),
                    'vmagazine_featured_post_type' => array(
                        'vmagazine_widgets_name' => 'vmagazine_featured_post_type',
                        'vmagazine_widgets_title' => esc_html__( 'Featured Posts Display', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'radio',
                        'vmagazine_widgets_default' => 'latest_posts',
                        'vmagazine_widgets_field_options' => $vmagazine_posts_type
                    ),
                    'vmagazine_featured_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Category for Featured Posts', 'vmagazine-companion' ),
                        'vmagazine_widgets_default'      => 0,
                        'vmagazine_widgets_field_type' => 'select',
                        'vmagazine_widgets_field_options' => $vmagazine_cat_dropdown
                    ),
                    ...
                    'block_section_excerpt' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Excerpt for post description', 'vmagazine-companion' ),
                        'vmagazine_widgets_description' => esc_html__( 'Enter excerpts in number of letters Default: 150', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'number',
                     ...
                     'vmagazine_featured_view_all_text' => array(
                        ...
                        'vmagazine_widgets_title'        => esc_html__( 'View All Button Text', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type'   => 'text'
                    ),
                //general closing
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'block_section_meta' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Hide/Show Meta', 'vmagazine-companion' ),
                        'vmagazine_widgets_default'=>'show',
                        'vmagazine_widgets_field_options'=>array('show'=>'Show','hide'=>'Hide'),
                        'vmagazine_widgets_field_type' => 'switch',
                    ...
                    'block_section_btn_txt_color' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'View All Button Text Color', 'vmagazine-companion' ),
                    ...
                    'block_section_btn_txt_color_hover' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'View All Button Text Color: Hover', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'color'
                    ),  
                    'block_section_btn_border_color' => array(
                        'vmagazine_widgets_name' => 'block_section_btn_border_color',
                        'vmagazine_widgets_title' => esc_html__( 'View All Button Border Color', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'color'
                    ),
