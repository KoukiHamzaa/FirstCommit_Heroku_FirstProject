...
class Vmagazine_Post_Carousel_Small extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display small carousel slider  .', 'vmagazine-companion' )
        );
        parent::__construct( 'Vmagazine_Post_Carousel_Small', esc_html__( 'Vmagazine: Carousel Slider(Small)', 'vmagazine-companion' ), $widget_ops );
    }
