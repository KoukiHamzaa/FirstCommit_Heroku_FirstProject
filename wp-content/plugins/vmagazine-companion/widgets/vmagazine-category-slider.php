...
class vmagazine_category_posts_slider extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display posts from selected category as slider.', 'vmagazine-companion' )
        );
        $width = array(
                'width'  => 600
        );
        parent::__construct( 'vmagazine_category_posts_slider', esc_html__( 'Vmagazine : Category Posts(Slider)', 'vmagazine-companion' ), $widget_ops , $width );
    }
        ...
        $fields = array(
            ...
            'block_wrapper_start' => array(
                ...
                'block_slider_layout' => array(
                    ...
                    'vmagazine_widgets_title' => esc_html__( 'Slider Layouts', 'vmagazine-companion' ),
                    'vmagazine_widgets_description' => esc_html__( 'Choose the slider layout from available options.', 'vmagazine-companion' ),
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'block_post_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Select Category for Slider', 'vmagazine-companion' ),
                    ...
                    'block_section_excerpt' => array(
                        ...
                        'vmagazine_widgets_description' => esc_html__( 'Enter Excerpts in number of letters default: 180 &#40; exerpt will work on first layout only &#41;', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'number',
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'cat_bg_image' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Background Image', 'vmagazine-companion' ),
                    ...
                    'block_section_btn_border_color' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'View All Button Border Color: Hover', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'color'
                    ),
