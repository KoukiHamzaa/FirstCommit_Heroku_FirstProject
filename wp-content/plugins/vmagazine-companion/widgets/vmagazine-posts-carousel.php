...
class vmagazine_block_posts_carousel extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct( 'vmagazine_block_posts_carousel', esc_html__( 'Vmagazine : Block Posts(Carousel)', 'vmagazine-companion' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'block_post_layout' => array(
                ...
                'vmagazine_widgets_description' => esc_html__( 'Choose the block layout.', 'vmagazine-companion' ),
