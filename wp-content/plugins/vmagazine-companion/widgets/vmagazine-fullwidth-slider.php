...
class vmagazine_tab_posts_list extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display fullwidth slider with .', 'vmagazine-companion' )
        );
        $width = array(
                'width'  => 600
        );
        parent::__construct( 'vmagazine_tab_posts_list', esc_html__( 'Vmagazine: Fullwidth slider', 'vmagazine-companion' ), $widget_ops,$width );
    }
        ...
        'block_wrapper_start' => array(
            ...
            'tab_wrapper_general_start' => array(
                ...
                'block_post_type' => array(
                    ...
                    'vmagazine_widgets_title'       => esc_html__( 'Block Display Type', 'vmagazine-companion' ),
