...
class vmagazine_info extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'vmagazine_info', esc_html__('Vmagazine : Footer Info','vmagazine-companion'), array(
                'description' => esc_html__('A widget that shows information', 'vmagazine-companion')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'title_info' => array(
                ...
                'vmagazine_widgets_title' => esc_html__('Info Title', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
            'location' => array(
                'vmagazine_widgets_name' => 'location',
                'vmagazine_widgets_title' => esc_html__('Location', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
            'phone' => array(
                'vmagazine_widgets_name' => 'phone',
                'vmagazine_widgets_title' => esc_html__('Phone', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
            'fax' => array(
                'vmagazine_widgets_name' => 'fax',
                'vmagazine_widgets_title' => esc_html__('Fax', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
            'email' => array(
                'vmagazine_widgets_name' => 'email',
                'vmagazine_widgets_title' => esc_html__('Email', 'vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text',
            ),
