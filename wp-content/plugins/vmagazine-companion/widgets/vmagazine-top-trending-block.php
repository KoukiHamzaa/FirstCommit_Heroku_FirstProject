...
class Vmagazine_Top_Trending_Block extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display 4 news in square format', 'vmagazine-companion' )
        );
        parent::__construct( 'Vmagazine_Top_Trending_Block', esc_html__( 'Vmagazine: Top Trending', 'vmagazine-companion' ), $widget_ops );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            'block_section_meta' => array(
                ...
                'vmagazine_widgets_title' => esc_html__( 'Hide/Show Post Meta', 'vmagazine-companion' ),
