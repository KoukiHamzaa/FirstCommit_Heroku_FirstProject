...
*/
define( 'VMAG_WIDGET_IMG_URI', VMC_URL .'/assets/widgets-layouts/' );
...
$vmagazine_cat_dropdown['0'] = esc_html__( '--Select Category--', 'vmagazine-companion' );
foreach ( $vmagazine_categories as $vmagazine_category ) {
...
$vmagazine_posts_type = array(
    'latest_posts'   => esc_html__( 'From Latest Posts', 'vmagazine-companion' ),
    'random_posts'   => esc_html__( 'Random Posts', 'vmagazine-companion' ),
    'category_posts' => esc_html__( 'From Selected Category', 'vmagazine-companion' )
    );
...
$vmagazine_column_choice = array(
  ''    => esc_html__( 'Select No.of Column', 'vmagazine-companion' ),
  '1' => esc_html__( '1 Column', 'vmagazine-companion' ),
  '2' => esc_html__( '2 Columns', 'vmagazine-companion' ),
  '3' => esc_html__( '3 Columns', 'vmagazine-companion' ),
  '4' => esc_html__( '4 Columns', 'vmagazine-companion' )
  );
...
$vmagazine_block_layout = array(
    'block_layout_1' =>  esc_html__( 'Layout 1', 'vmagazine-companion' ),
    'block_layout_2' =>  esc_html__( 'Layout 2', 'vmagazine-companion' ),
    );

$vmagazine_block_post_layout = array(
    'block_layout_1' =>  esc_html__( 'Layout 1', 'vmagazine-companion' ),
    'block_layout_2' =>  esc_html__( 'Layout 2', 'vmagazine-companion' ),
    'block_layout_3' =>  esc_html__( 'Layout 3', 'vmagazine-companion' ),
    );


$vmagazine_block_post_layout_col = array(
    'block_layout_1' =>  esc_html__( 'Layout 1', 'vmagazine-companion' ),
    'block_layout_3' =>  esc_html__( 'Layout 2', 'vmagazine-companion' ),
    'block_layout_4' =>  esc_html__( 'Layout 3', 'vmagazine-companion' ),
    );
...
$vmagazine_grdlst_layout = array(
    'grid' =>  esc_html__( 'Grid Layout', 'vmagazine-companion' ),
    'list' => esc_html__('List Layout','vmagazine-companion'),
    'grid-two' => esc_html__('Grid Two Layout','vmagazine-companion'),
    );
...
$vmagazine_pagination_layout = array(
    'ajax_loader' =>  esc_html__( 'Ajax Loader', 'vmagazine-companion' ),
    'view_all' => esc_html__('View All Button','vmagazine-companion')
    );
...
$vmagazine_admin_roles = array(
    'subscriber'  => esc_html__( 'Subscriber', 'vmagazine-companion' ),
    'contributor' => esc_html__( 'Contributor', 'vmagazine-companion' ),
    'author'    => esc_html__( 'Author', 'vmagazine-companion' ),
    'editor'    => esc_html__( 'Editor', 'vmagazine-companion' ),
    'administrator' => esc_html__( 'Administrator', 'vmagazine-companion' ),
  );
...
function vmagazine_widget_enqueue_scripts(){
    ...
    wp_enqueue_style( 'vmagazine-widget',VMC_URL.'/widgets/assets/vmagazine_wie.css', array(), VMAG_VER );
    wp_enqueue_script( 'vmagazine-widget',VMC_URL.'/widgets/assets/vmagazine_wie.js', array( 'jquery' ), VMAG_VER, true );
}
...
require VMC_PATH . 'widgets/widget-fields.php'; // widget fields
require VMC_PATH . 'widgets/vmagazine-featured-slider.php'; // Feature slider
require VMC_PATH . 'widgets/vmagazine-fullwidth-slider.php'; // Fullwidth slider
require VMC_PATH . 'widgets/vmagazine-multiple-category.php'; // Multiple category posts
require VMC_PATH . 'widgets/vmagazine-categories-tab.php'; // Categories Tab
require VMC_PATH . 'widgets/vmagazine-post-column.php'; // Post column
require VMC_PATH . 'widgets/vmagazine-grid-list.php'; // Grid/List
require VMC_PATH . 'widgets/vmagazine-posts-carousel.php'; //post Carousel
require VMC_PATH . 'widgets/vmagazine-category-slider.php'; // Category posts slider
require VMC_PATH . 'widgets/vmagazine-slider-tab.php'; // Slider Tab
require VMC_PATH . 'widgets/vmagazine-timeline-posts.php'; // Timeline Posts
require VMC_PATH . 'widgets/vmagazine-medium-ad.php'; // Medium ad
require VMC_PATH . 'widgets/vmagazine-footer-info.php'; // Footer-info
require VMC_PATH . 'widgets/vmagazine-recent-posts.php';
require VMC_PATH . 'widgets/vmagazine-slider-tab-carousel.php';
require VMC_PATH . 'widgets/vmagazine-multiple-category-tabbed.php';
require VMC_PATH . 'widgets/vmagazine-block-post-slider.php';
require VMC_PATH . 'widgets/vmagazine-fb-like.php';//Facebook page like 
require VMC_PATH . 'widgets/vmagazine-flicker-stream.php';//Flicker gallery
require VMC_PATH . 'widgets/vmagazine-video-playlist.php';// Youtube Video Playlist
require VMC_PATH . 'widgets/vmagazine-media-player.php';// Media player
require VMC_PATH . 'widgets/vmagazine-top-trending-block.php';// trending news section
require VMC_PATH . 'widgets/vmagazine-block-post-carousel(small).php';
require VMC_PATH . 'widgets/vmagazine-about-author.php';