...
class vmagazine_flickr_stream extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Vmagazine : Flickr Stream', 'vmagazine-companion'),
            array(
                'description' => __('Displays your Flickr photos.', 'vmagazine-companion' )
            )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'widget_title' => array(
                ...
                'vmagazine_widgets_title' => esc_html__( 'Title', 'vmagazine-companion' ),
                'vmagazine_widgets_field_type' => 'text'
            ),
            // Other fields
            'flickr_id' => array(
                'vmagazine_widgets_name' => 'flickr_id',
                'vmagazine_widgets_title' => esc_html__( 'Flickr ID', 'vmagazine-companion' ),
                'vmagazine_widgets_description' => esc_html__('eg: 150375770@N32','vmagazine-companion'),
                'vmagazine_widgets_field_type' => 'text'
            ),
            'photo_count' => array(
                'vmagazine_widgets_name' => 'photo_count',
                'vmagazine_widgets_title' => esc_html__( 'Number of Photos', 'vmagazine-companion' ),
                'vmagazine_widgets_field_type' => 'number'
               
            ),
            'photo_type' => array(
                'vmagazine_widgets_name' => 'photo_type',
                'vmagazine_widgets_title' => esc_html__( 'Type (user or group)', 'vmagazine-companion' ),
                'vmagazine_widgets_field_type' => 'select',
                'vmagazine_widgets_field_options' => array(
                    'user' => esc_html__('User', 'vmagazine-companion'),
                    'group' => esc_html__('Group', 'vmagazine-companion')
                )
            ),
            'photo_display' => array(
                'vmagazine_widgets_name' => 'photo_display',
                'vmagazine_widgets_title' => esc_html__( 'Display', 'vmagazine-companion' ),
                'vmagazine_widgets_field_type' => 'select',
                'vmagazine_widgets_field_options' => array(
                    'latest' => esc_html__('Latest', 'vmagazine-companion'),
                    'random' => esc_html__('Random', 'vmagazine-companion')
                )
            )
        );
