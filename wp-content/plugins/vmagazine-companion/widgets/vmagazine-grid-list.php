...
class vmagazine_block_grid_list extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display posts in grid or list format.', 'vmagazine-companion' )
        );
        $width = array(
                'width'  => 600
        );
        parent::__construct( 'vmagazine_block_grid_list', esc_html__( 'Vmagazine : Grid/List Posts', 'vmagazine-companion' ), $widget_ops, $width );
    }
        ...
        $fields = array(
            ...
            'block_wrapper_start' => array(
                ...
                'block_post_layout' => array(
                    ...
                    'vmagazine_widgets_title' => esc_html__( 'Block Layouts', 'vmagazine-companion' ),
                    'vmagazine_widgets_description' => esc_html__( 'Choose the block layout from available options.', 'vmagazine-companion' ),
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'block_post_type' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Block posts: ', 'vmagazine-companion' ),
                    ...
                    'block_post_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Category for Block Posts', 'vmagazine-companion' ),
                   ...
                   'block_posts_offset' => array(
                    ...
                    'pagination_show' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Pagination Type', 'vmagazine-companion' ),
                    ...
                    'block_section_excerpt' => array(
                        ...
                        'vmagazine_widgets_description' => esc_html__( 'Enter excerpts in number of letters default: 200 &#40; this will only work on second and last layout &#41;', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'number',
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'block_section_border_color' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Post Seperator Border Color', 'vmagazine-companion' ),
    ...
    <?php endif; ?>
        <div class="vmagazine-grid-list block-post-wrapper <?php echo esc_attr($vmagazine_block_layout);?>">
            ...
            if($vmagazine_block_posts_type=='category_posts'){
                $id = $vmagazine_block_cat_id;
            }else{
                $id = '';
            }?>
            <div class="gl-posts" data-meta="<?php echo esc_attr($block_section_meta);?>" data-cat="<?php echo esc_attr($id);?>" data-paged="<?php echo esc_attr($paged);?>" data-banner-offset="<?php echo absint($vmagazine_block_posts_count); ?>" data-offset="<?php echo esc_attr($vmagazine_block_posts_type);?>" data-type="<?php echo esc_attr($vmagazine_block_layout);?>" data-id="<?php echo absint($vmagazine_block_posts_count);?>" data-length="<?php echo absint($block_section_excerpt)?>">
