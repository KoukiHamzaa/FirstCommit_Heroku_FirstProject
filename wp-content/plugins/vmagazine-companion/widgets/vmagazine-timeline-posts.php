...
class vmagazine_timeline_posts_list extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array( 
            ...
            'description' => esc_html__( 'Display posts from selected category as timeline list.', 'vmagazine-companion' )
        );
        parent::__construct( 'vmagazine_timeline_posts_list', esc_html__( 'Vmagazine : Timeline Posts', 'vmagazine-companion' ), $widget_ops );
    }
            ...
            'block_wrapper_start' => array(
                ...
                'tab_wrapper_general_start' => array(
                    ...
                    'block_post_category' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Select Category for Lists', 'vmagazine-companion' ),
                ...
                'tab_wrapper_adv_start' => array(
                    ...
                    'block_section_bg_color' => array(
                        ...
                        'vmagazine_widgets_title' => esc_html__( 'Widget Background Color', 'vmagazine-companion' ),
                        'vmagazine_widgets_field_type' => 'color'
                    ),  
