...
<div class='apif-wrapper clearfix'>
  <section class="ap-shortcode-wrapper apif-filter-layout-view apif_<?php echo $layout;?> apif-isotope-wrapper" id="apif-shortcode-wrapper">
    ...
    <div class="ap_commond_div_for_pretty_photo_lightbox apif-<?php echo $layout;?>" data-feed-id='<?php echo $generated_random_no; ?>'>
     ...
     if(isset($ins_media['meta']['error_message'])){
      ...
      ?>    
      <div class="apifeeds-filtr-container apifeeds-overlay-effect ap_feeds-masonry_layout apif-template-masonry_layout3" id="apif_container_<?php echo $generated_random_no; ?>" data-id="<?php echo $generated_random_no; ?>" data-layout="<?php
...
?>
<div class="ap-self-user-feed apif-masonry-box <?php echo $columns_desktop;?> <?php echo $animation_effect;?> apif-filter-all <?php echo $media_type_class;?> apif-masnry-ui-three">
 <div class="apif-masonry-block">  
  <figure>
  ...
  <div class="apif-view-n-popup">
   ...
   if(isset($apif_settings['enable_lightbox'])){ 
    if($apif_settings['lightbox_layout'] == 'preety_photo'){
      ...
      ?>
      <a class="example-image-link" href="<?php echo esc_url($image); ?>" data-lightbox="example-set">image link</a>
      <?php
