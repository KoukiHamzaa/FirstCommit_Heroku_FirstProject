...
if($shortcode_column != ''){
$masonary_layout1_no_of_columns = $shortcode_column;
}else{
$masonary_layout1_no_of_columns = isset($column_option['desktop']) ? $column_option['desktop'] : '3';
}
$totalcolumn = $masonary_layout1_no_of_columns;
...
if(isset($attr['hover_animation']) && $attr['hover_animation'] != ''){
 $masonary_layout1_animation_effect = $attr['hover_animation'];
}
$masonary_layout1_animation_effect = (isset($masonary_layout1_animation_effect) && $masonary_layout1_animation_effect != '')?$masonary_layout1_animation_effect:'apif-top-to-bottom';
$m1large_desktop_column = (isset($column_option['largedesktop']) && $column_option['largedesktop'] != '') ? 'apif-large-desktop-col-'.$column_option['largedesktop'] : 'apif-large-desktop-col-4';
?>
...
?>
<div class="ap-self-user-feed apif-masonry-box <?php if(isset($masonary_layout1_no_of_columns)){ echo $masonary_layout1_no_of_columns; }else{ echo 'apif-col-3'; } ?> <?php if(isset($masonary_layout1_animate_css_effect) && $masonary_layout1_animate_css_effect !=''){ echo 'wow '.$masonary_layout1_animate_css_effect; } ?> apif-masnry-ui-one apif-masnry-ui-one-<?php echo $if_id; ?> <?php echo $masonary_layout1_animation_effect;?> <?php echo $m1large_desktop_column;?>" data-wow-duration="2s">
                <div class="apif-masonry-block" style="<?php if(isset($masonary_layout1_background_color) && $masonary_layout1_background_color !=''){ echo 'background: '. $masonary_layout1_background_color; } ?>; <?php if(isset($masonary_layout1_border_width) && $masonary_layout1_border_width !=''){ echo 'border:' . $masonary_layout1_border_width; } ?>px solid <?php if(isset($masonary_layout1_border_color)){ echo $masonary_layout1_border_color; } ?> !important;">
                    <figure>
                        <div class="apif-featimg">
                            ...
                            if($vm['type'] == 'video'){
                                ?>
                                <a class="example-image-link" href="<?php echo $vm['videos']['low_bandwidth']['url']; ?>" style="background-image: url(<?php echo esc_url($image); ?>);">
                                    <?php /*
                                    <img class="the-thumb" src="<?php echo esc_url($image); ?>" alt='<?php echo strip_tags(substr($captiontext, 0, 20)); ?>'> */ ?>
                                </a>
                                <?php
                            }else{ ?>
                                <a class="example-image-link" href="#" style="background-image: url(<?php echo esc_url($image); ?>);">
                                     <?php /*<img class="the-thumb apif-feature-image" src="<?php echo esc_url($image); ?>" alt='<?php echo strip_tags(substr($captiontext, 0, 20)); ?>'> */ ?>
                                </a>
                                <?php
                            } ?>
                </div>
                ...
                <span class="apif-ins-link" style="margin-top: 30px;"><?php
...
<?php if(!empty($ins_media['pagination']) && isset($masonary_layout1_load_more_button_enable) && $masonary_layout1_load_more_button_enable == 1){ ?>
<div class='ap_pagination <?php if(isset($masonary_layout1_load_more_button_position)){ echo $masonary_layout1_load_more_button_position; }else{ echo "apif-left";  } ?> clearfix'>
<a href='javascript:void(0);' class='load-more-button apif-load-more-button load-more-button-<?php echo $layout; ?> apif-id-<?php echo $if_id; ?>'
    ...
    data-layout-name="masonry_layout1"
    ...
    data-largedesktopcolumn = "<?php echo $m1large_desktop_column;?>"
    data-hoveranimation = "<?php echo $masonary_layout1_animation_effect;?>"
    >
    <?php if(isset($masonary_layout1_load_more_button_text) && $masonary_layout1_load_more_button_text !=''){ echo $masonary_layout1_load_more_button_text; }else{ echo "Load more";  } ?></a>
    <div id='ap_wait_loader-masonry_layout1' class='ap_wait_loader' style='display:none;'>
        <?php if(isset($masonary_layout1_load_more_button_icon)){ ?>
            <img src='<?php echo APIF_IMAGE_DIR."/loaders/loader".$masonary_layout1_load_more_button_icon.".gif"; ?>' alt='Loading' />
        <?php }else{ ?>
...
background: <?php if(isset($masonary_layout1_load_more_button_background_color) && $masonary_layout1_load_more_button_background_color!=''){ echo $masonary_layout1_load_more_button_background_color; }else{ echo "#000"; } ?>; /* #000; masonary_layout1_load_more_button_background_color */
color: <?php if(isset($masonary_layout1_load_more_button_text_color) && $masonary_layout1_load_more_button_text_color!=''){ echo $masonary_layout1_load_more_button_text_color; }else{ echo "#f4f4f4"; } ?>;  /* #f4f4f4; masonary_layout1_load_more_button_text_color */
border:2px solid <?php if(isset($masonary_layout1_load_more_button_border_color) && $masonary_layout1_load_more_button_border_color !=''){ echo $masonary_layout1_load_more_button_border_color; }else{ echo "#000"; } ?>; /* #000 masonary_layout1_load_more_button_border_color */
}

.apif-id-<?php echo $if_id; ?>.load-more-button-<?php echo $layout; ?>:hover{ 
background: <?php if(isset($masonary_layout1_load_more_button_text_hover_background_color) && $masonary_layout1_load_more_button_text_hover_background_color!=''){ echo $masonary_layout1_load_more_button_text_hover_background_color; }else{ echo "#f1f1f1"; } ?>; /* #f1f1f1 masonary_layout1_load_more_button_text_hover_background_color */
color: <?php if(isset($masonary_layout1_load_more_button_hover_text_color) && $masonary_layout1_load_more_button_hover_text_color!=''){ echo $masonary_layout1_load_more_button_hover_text_color; }else{ echo "#000"; } ?>; /* #000 masonary_layout1_load_more_button_hover_text_color */
border:2px solid <?php if(isset($masonary_layout1_load_more_button_hover_border_color) && $masonary_layout1_load_more_button_hover_border_color !=''){ echo $masonary_layout1_load_more_button_hover_border_color; }else{ echo "#000"; } ?>; /* #000 masonary_layout1_load_more_button_border_color */
}

<?php if(isset($hover_image_text_color) && $hover_image_text_color !=''){ ?>
.apif-masnry-ui-one-<?php echo $if_id; ?> figure .profile-image {
border: 3px solid <?php echo $hover_image_text_color; ?>;
}

.apif-masnry-ui-one-<?php echo $if_id; ?> figure .apif-view-n-popup a i {
color: <?php echo $hover_image_text_color; ?>;
}
.apif-masnry-ui-one-<?php echo $if_id; ?> figure .apif-view-n-popup i {
border: 2px solid <?php echo $hover_image_text_color; ?>;
}

.apif-masnry-ui-one-<?php echo $if_id; ?>:hover figure .apif-overlay-cont-block:before {
border: 2px solid <?php echo $hover_image_text_color; ?>;
}
<?php } ?>

<?php if(isset($masonary_layout1_text_color) && $masonary_layout1_text_color !=''){ ?>

.ap_posted_ago-<?php echo $if_id; ?>, .apif-image-caption-<?php echo $if_id; ?> {
color: <?php echo $masonary_layout1_text_color; ?>!important;
}
