...
// echo "Desktop detected";
    if($shortcode_column != ''){
     $masonary_layout_no_of_columns = $shortcode_column;
    }else{
      $masonary_layout_no_of_columns = isset($column_option['desktop']) ? $column_option['desktop'] : '3';
    }
    $totalcolumn = $masonary_layout_no_of_columns;
}
...
if(isset($attr['hover_animation']) && $attr['hover_animation'] != ''){
 $masonary_layout_animation_effect = $attr['hover_animation'];
}
$masonary_layout_animation_effect = (isset($masonary_layout_animation_effect) && $masonary_layout_animation_effect != '')?$masonary_layout_animation_effect:'apif-top-to-bottom';
$m2large_desktop_column = (isset($column_option['largedesktop']) && $column_option['largedesktop'] != '') ? 'apif-large-desktop-col-'.$column_option['largedesktop'] : 'apif-large-desktop-col-4';
?>
...
?>
        ...
        <div class="ap-self-user-feed apif-masonry-box <?php if(isset($masonary_layout_no_of_columns)){ echo $masonary_layout_no_of_columns; }else{ echo 'apif-col-3'; } ?> <?php if(isset($masonary_layout_animate_css_effect) && $masonary_layout_animate_css_effect !=''){ echo 'wow '.$masonary_layout_animate_css_effect; } ?> <?php if(isset($masonary_layout_animation_effect)){ echo $masonary_layout_animation_effect; }else{ echo "apif-right-to-left"; } ?> apif-masnry-default <?php echo $m2large_desktop_column;?>" data-wow-duration="2s" >
                    ...
                    <div class="apif-featimg">
                        <?php if($vm['type'] == 'video'){
                            ...
                            <a class="example-image-link" href="<?php echo $vm['videos']['low_bandwidth']['url']; ?>" style="background-image: url(<?php echo esc_url($image); ?>);">
                               <?php /* <img class="the-thumb" src="<?php echo esc_url($image); ?>" alt='<?php echo strip_tags(substr($captiontext, 0, 20)); ?>'> */ ?>
                            </a>
                            <?php }else{ ?>
                            <a class="example-image-link" href="#" style="background-image: url(<?php echo esc_url($image); ?>);">
                            <?php /*
                                <img class="the-thumb apif-feature-image" src="<?php echo esc_url($image); ?>" alt='<?php echo strip_tags(substr($captiontext, 0, 20)); ?>'> */ ?>
                            </a>
                            <?php } ?>
                        </div>
                        ...
                        <?php if(isset($instagram_image_link)){ 
                         ...
                         <div class="apif-middle-content-wrapper"> 
                                <div class="apif-inner-content-wrapper"> 
                                     <?php
                                     if($masonary_layout_animation_effect == "apif-img-creative"){?>                                
                                 ...
                                 <?php }else if($masonary_layout_animation_effect == "apif-img-sweetmarley" || $masonary_layout_animation_effect == "apif-img-tender" || $masonary_layout_animation_effect == "apif-img-jolly" || $masonary_layout_animation_effect == "apif-img-strongapollo" || $masonary_layout_animation_effect == "apif-img-darkkiraview"){ 
                                         if($masonary_layout_animation_effect == "apif-img-tender"){
                                           $classanimte = "tender";
                                         }else if($masonary_layout_animation_effect == "apif-img-jolly"){
                                           $classanimte = "jolly";
                                         }else if($masonary_layout_animation_effect == "apif-img-strongapollo"){
                                           $classanimte = "strongapollo";
                                         }else if($masonary_layout_animation_effect == "apif-img-sweetmarley"){
...
<?php if(!empty($ins_media['pagination']) && isset($masonary_layout_load_more_button_enable) && $masonary_layout_load_more_button_enable == 1){ ?>
<div class='ap_pagination <?php if(isset($masonary_layout_load_more_button_position)){ echo $masonary_layout_load_more_button_position; }else{ echo "apif-left";  } ?> clearfix'>
...
data-layout-name="masonry_layout"
...
data-largedesktopcolumn = "<?php echo $m2large_desktop_column;?>"
data-hoveranimation = "<?php echo $masonary_layout_animation_effect;?>"
>
<?php if(isset($masonary_layout_load_more_button_text) && $masonary_layout_load_more_button_text != ''){ echo $masonary_layout_load_more_button_text; }else{ echo "Load more";  } ?></a>
<div id='ap_wait_loader-masonry_layout' class='ap_wait_loader' style='display:none;'>
    <?php if(isset($masonary_layout_load_more_button_icon)){ ?>
    <img src='<?php echo APIF_IMAGE_DIR."/loaders/loader".$masonary_layout_load_more_button_icon.".gif"; ?>' alt='Loading' />
    <?php }else{ ?>
...
<?php if(isset($masonary_layout_load_more_button_background_color) && $masonary_layout_load_more_button_background_color!=''){  ?>
    background: <?php echo $masonary_layout_load_more_button_background_color; ?>;
    <?php } ?>
    <?php if(isset($masonary_layout_load_more_button_text_color) && $masonary_layout_load_more_button_text_color!=''){ ?>
        color: <?php  echo $masonary_layout_load_more_button_text_color; ?>;
        <?php } ?>
        <?php if(isset($masonary_layout_load_more_button_border_color) && $masonary_layout_load_more_button_border_color !=''){ ?>
            border:2px solid <?php  echo $masonary_layout_load_more_button_border_color; ?>;
            <?php } ?>
        }

        .apif-id-<?php echo $if_id; ?>.load-more-button-<?php echo $layout; ?>:hover{
            <?php if(isset($masonary_layout_load_more_button_text_hover_background_color) && $masonary_layout_load_more_button_text_hover_background_color!=''){ ?>
                background: <?php echo $masonary_layout_load_more_button_text_hover_background_color; ?>;
                <?php } ?>
                <?php if(isset($masonary_layout_load_more_button_hover_text_color) && $masonary_layout_load_more_button_hover_text_color!=''){ ?>
                    color: <?php echo $masonary_layout_load_more_button_hover_text_color; ?>; 
                    <?php } ?>
                    <?php if(isset($masonary_layout_load_more_button_hover_border_color) && $masonary_layout_load_more_button_hover_border_color !=''){ ?>
                        border:2px solid <?php echo $masonary_layout_load_more_button_hover_border_color; ?>;
                        <?php } ?>
