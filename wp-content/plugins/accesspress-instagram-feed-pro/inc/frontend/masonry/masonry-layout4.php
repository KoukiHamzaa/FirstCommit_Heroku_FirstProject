<?php
// Masonary Template - Light Masonary Layout
$totalcolumn = 4;
...
// Exclude tablets.
if(isset($apif_settings['masonary_layout4'])){
    $column_option = $apif_settings['masonary_layout4']['columns'];
    if( $detect->isMobile() && !$detect->isTablet() ){
// echo "Mobile Detected";
$masonary_layout4_no_of_columns = isset($column_option['mobile']) ? $column_option['mobile'] : '1'; // "apif-col-1";
}
// Any tablet device.
else if( $detect->isTablet() ){
// echo "Tablet Detected";
    $masonary_layout4_no_of_columns = isset($column_option['tablet']) ? $column_option['tablet'] : '3';
}
// any desktop devices
else{
// echo "Desktop detected";
   if($shortcode_column != ''){
    $masonary_layout4_no_of_columns = $shortcode_column;
    }else{
      $masonary_layout4_no_of_columns = isset($column_option['desktop']) ? $column_option['desktop'] : '3';
    }
    $totalcolumn = $masonary_layout4_no_of_columns;
}

$masonary_layout4_no_of_columns = "apif-col-$masonary_layout4_no_of_columns";
}else{
    $masonary_layout4_no_of_columns = $masonary_layout4_no_of_columns;
}
...
/*if(isset($attr['hover_animation']) && $attr['hover_animation'] != ''){
 $masonary_layout4_animation_effect = $attr['hover_animation'];
}*/
$m5large_desktop_column = (isset($column_option['largedesktop']) && $column_option['largedesktop'] != '') ? 'apif-large-desktop-col-'.$column_option['largedesktop'] : 'apif-large-desktop-col-4';
?>
<div class='apif-wrapper'>
    <section id="apif-shortcode-wrapper" class="apif-masonry-view apif-isotope-wrapper">
        ...
        if($hide_profile_link == 1){
            ...
            $html_profile_userlink = "<a href='".$url_profilelink."' target='_blank' ".$hover_text_color_style." ".$hover_text_color_style.">".$data_username."</a>";
        }
$image = IF_Pro_Class::check_ifexist_image($image,$image_size,$permalink);
 ?>
<div class="ap-self-user-feed apif-masonry-box <?php if(isset($masonary_layout4_no_of_columns)){ echo $masonary_layout4_no_of_columns; }else{ echo 'apif-col-3'; } ?> <?php echo $m5large_desktop_column;?> <?php if(isset($masonary_layout4_animate_css_effect) && $masonary_layout4_animate_css_effect !=''){ echo 'wow '.$masonary_layout4_animate_css_effect; } ?> apif-masnry-ui-four apif-masnry-ui-four-<?php echo $if_id; ?>" data-wow-duration="2s">
    <div class="apif-masonry-block" style="background: <?php if(isset($masonary_layout4_background_color)){ echo $masonary_layout4_background_color; }else{ echo '#f9f9f9'; } ?>  !important; border:<?php if(isset($masonary_layout4_border_width)){ echo $masonary_layout4_border_width; }else{ echo '2'; } ?>px solid <?php if(isset($masonary_layout4_border_color)){ echo $masonary_layout4_border_color; }else{ echo '#fd7062'; } ?> !important;">
        <figure>
                ...
                <div class="apif-view-n-popup">
                   <?php if(isset($apif_settings['enable_lightbox'])){
                    ...
                    <div class="apif-fig-content">
                        ...
                        <div class='apif-image-caption' style='color:<?php if(isset($masonary_layout4_text_color)){ echo $masonary_layout4_text_color; } ?>;'>
...
<?php if(!empty($ins_media['pagination']) && isset($masonary_layout4_load_more_button_enable) && $masonary_layout4_load_more_button_enable == 1){ ?>
<div class='ap_pagination <?php if(isset($masonary_layout4_load_more_button_position)){ echo $masonary_layout4_load_more_button_position; }else{ echo "apif-left";  } ?> clearfix'>
    <a href='javascript:void(0);' class='load-more-button apif-load-more-button load-more-button-<?php echo $layout; ?> apif-id-<?php echo $if_id; ?>'
        ...
        data-layout-name="masonry_layout4"
        ...
        data-largedesktopcolumn = "<?php echo $m5large_desktop_column;?>"
        data-hoveranimation = ""
        >
        <?php if(isset($masonary_layout4_load_more_button_text) && $masonary_layout4_load_more_button_text !=''){ echo $masonary_layout4_load_more_button_text; }else{ echo "Load more";  } ?></a>
        <div id='ap_wait_loader-masonry_layout4' class='ap_wait_loader' style='display:none;'>
            <?php if(isset($masonary_layout4_load_more_button_icon)){ ?>
            <img src='<?php echo APIF_IMAGE_DIR."/loaders/loader".$masonary_layout4_load_more_button_icon.".gif"; ?>' alt='Loading' />
            <?php }else{ ?>
...
<?php } ?>
    <?php if(isset($hover_image_text_color) && $hover_image_text_color !=''){ ?> 
        .apif-masnry-ui-four-<?php echo $if_id; ?> figure .apif-view-n-popup i {
            border: 2px solid <?php echo $hover_image_text_color; ?>;
        }
        .apif-masnry-ui-four-<?php echo $if_id; ?> figure .apif-view-n-popup a i {
            color: <?php echo $hover_image_text_color; ?>;
        }

        .apif-masnry-ui-four-<?php echo $if_id; ?>:hover figure .apif-overlay-cont-block:before {
            border: 2px solid <?php echo $hover_image_text_color; ?>;
        }
        <?php } ?>

        .apif-id-<?php echo $if_id; ?>.load-more-button-<?php echo $layout; ?> {
          background: <?php if(isset($masonary_layout4_load_more_button_background_color) && $masonary_layout4_load_more_button_background_color!=''){ echo $masonary_layout4_load_more_button_background_color; }else{ echo "#000"; } ?>; /* #000; masonary_layout4_load_more_button_background_color */
          color: <?php if(isset($masonary_layout4_load_more_button_text_color) && $masonary_layout4_load_more_button_text_color!=''){ echo $masonary_layout4_load_more_button_text_color; }else{ echo "#f4f4f4"; } ?>;  /* #f4f4f4; masonary_layout4_load_more_button_text_color */
          border:2px solid <?php if(isset($masonary_layout4_load_more_button_border_color) && $masonary_layout4_load_more_button_border_color !=''){ echo $masonary_layout4_load_more_button_border_color; }else{ echo "#000"; } ?>; /* #000 masonary_layout4_load_more_button_border_color */
      }

      .apif-id-<?php echo $if_id; ?>.load-more-button-<?php echo $layout; ?>:hover{ 
        background: <?php if(isset($masonary_layout4_load_more_button_text_hover_background_color) && $masonary_layout4_load_more_button_text_hover_background_color!=''){ echo $masonary_layout4_load_more_button_text_hover_background_color; }else{ echo "#f1f1f1"; } ?>; /* #f1f1f1 masonary_layout4_load_more_button_text_hover_background_color */
        color: <?php if(isset($masonary_layout4_load_more_button_hover_text_color) && $masonary_layout4_load_more_button_hover_text_color!=''){ echo $masonary_layout4_load_more_button_hover_text_color; }else{ echo "#000"; } ?>; /* #000 masonary_layout4_load_more_button_hover_text_color */
        border:2px solid <?php if(isset($masonary_layout4_load_more_button_hover_border_color) && $masonary_layout4_load_more_button_hover_border_color !=''){ echo $masonary_layout4_load_more_button_hover_border_color; }else{ echo "#000"; } ?>; /* #000 masonary_layout4_load_more_button_border_color */
    }
</style>
</div>
<?php
