<?php
    ...
    if(isset($apif_settings['masonary_layout3'])){
        ...
        // any desktop devices
            ...
            if($totalcolumn != ''){
                  $masonary_layout3_no_of_columns = $totalcolumn;
               }else{
                    $masonary_layout3_no_of_columns = isset($column_option['desktop']) ? $column_option['desktop'] : $masonary_layout3_no_of_columns;
               }
...
?>
<div class="ap-self-user-feed apif-masonry-box <?php if(isset($masonary_layout3_no_of_columns)){ echo $masonary_layout3_no_of_columns; }else{ echo 'apif-col-3'; } ?> <?php echo $largedesktopcolumn;?> <?php if(isset($masonary_layout3_animate_css_effect) && $masonary_layout3_animate_css_effect !=''){ echo 'wow '.$masonary_layout3_animate_css_effect; } ?> apif-masnry-ui-three apif-masnry-ui-three-<?php echo $if_id; ?>" data-wow-duration="2s">
        <div class="apif-masonry-block" style="background: <?php if(isset($masonary_layout3_background_color)){ echo $masonary_layout3_background_color; }else{ echo '#f9f9f9'; } ?>  !important; border:<?php if(isset($masonary_layout3_border_width)){ echo $masonary_layout3_border_width; }else{ echo '2'; } ?>px solid <?php if(isset($masonary_layout3_border_color)){ echo $masonary_layout3_border_color; }else{ echo '#fd7062'; } ?> !important;">
            <figure>
                <div class="apif-featimg">
                    <?php if($vm['type'] == 'video'){ ?>
                      <a href="<?php echo $vm['videos']['low_bandwidth']['url']; ?>" class="example-image-link" style="background-image: url(<?php echo esc_url($image); ?>);"></a></a>
                    <?php }else{ ?>
            ...
            <div class="apif-fig-content">
                ...
                <div class='apif-image-caption' style='color:<?php if(isset($masonary_layout3_text_color)){ echo $masonary_layout3_text_color; }else{ echo "#000"; } ?>;'>
                    <?php $reg_exUrl = "/(http|https|ftp|ftps|www|www.)\:\/\/[a-zA-Z0-9\-\.]+\.[a-zA-Z]{2,3}(\/\S*)?/";
                      $text = $captiontext;
