...
if(isset($apif_settings['masonary_layout4'])){
    ...
    // any desktop devices
       ...
       if($totalcolumn != ''){
          $masonary_layout4_no_of_columns = $totalcolumn;
       }else{
         $masonary_layout4_no_of_columns = isset($column_option['desktop']) ? $column_option['desktop'] : $masonary_layout1_no_of_columns;
       }
    }
...
<div class="ap-self-user-feed apif-masonry-box <?php if(isset($masonary_layout4_no_of_columns)){ echo $masonary_layout4_no_of_columns; }else{ echo 'apif-col-3'; } ?> <?php echo $largedesktopcolumn;?> <?php if( isset($masonary_layout4_animate_css_effect) && $masonary_layout4_animate_css_effect !='' ){ echo 'wow '.$masonary_layout4_animate_css_effect; } ?> apif-masnry-ui-four apif-masnry-ui-four-<?php echo $if_id; ?>" data-wow-duration="2s">
    <div class="apif-masonry-block" style="background: <?php if(isset($masonary_layout4_background_color)){ echo $masonary_layout4_background_color; }else{ echo '#f9f9f9'; } ?>  !important; border:<?php if(isset($masonary_layout4_border_width)){ echo $masonary_layout4_border_width; }else{ echo '2'; } ?>px solid <?php if(isset($masonary_layout4_border_color)){ echo $masonary_layout4_border_color; }else{ echo '#fd7062'; } ?> !important;">
        ...
        <div class="apif-fig-content">
            ...
            <div class='apif-image-caption clearfix' style='color:<?php if(isset($masonary_layout4_text_color)){ echo $masonary_layout4_text_color; } ?>;'>
               <?php
