...
if( class_exists( 'Elementor\Plugin' ) ) :
    class EAE_Posts_Group_Control extends Group_Control_Base {
        ...
        protected function init_fields() {
            ...
            $fields['post_type'] = [
                'label' => __( 'Source', 'vmagazine-ea' ),
                'type' => Controls_Manager::SELECT,
            ];

            $fields['posts_ids'] = [
                'label' => __( 'Search & Select', 'vmagazine-ea' ),
        ...
        protected function prepare_fields( $fields ) {
            ...
            $post_types = vmagazine_ea_get_post_types();



            $post_types_options = $post_types;

            $post_types_options['by_id'] = esc_html__( 'Manual Selection', 'vmagazine-ea' );
