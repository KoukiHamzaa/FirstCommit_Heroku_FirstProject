...
class APSS_Widget extends WP_Widget{
     ...
     public function form( $instance ){
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'title' ); ?>"><strong><?php _e( 'Title ', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'theme' ); ?>"><strong><?php _e( 'Theme ', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'counter' ); ?>"><strong><?php _e( 'Enable Counter', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
                    <input type="radio" name="<?php echo $this -> get_field_name( 'counter' ); ?>" <?php
                    if ( $counter == '1' ) {
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'total_counter' ); ?>"><strong><?php _e( 'Enable Total Counter', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
                    <input type="radio" name="<?php echo $this -> get_field_name( 'total_counter' ); ?>" <?php
                    if ( $total_counter == '1' ) {
                         echo "checked='checked'";
                    }
                    ?> value="1">Yes
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'networks' ); ?>"><strong><?php _e( 'Networks ', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
                    <textarea rows="4" class="widefat" id="<?php echo $this -> get_field_id( 'networks' ); ?>" name="<?php echo $this -> get_field_name( 'networks' ); ?>"><?php echo esc_attr( $networks ); ?></textarea>
               </p>
               <p>
               <div class='apss-note'><i><strong>Available networks </strong> facebook, twitter, google-plus, pinterest, linkedin, digg, delicious, reddit, stumbleupon, tumblr, vkontakte, xing, weibo, buffer, whatsapp, viber, sms, messenger, email, print, blogger, flipboard, kakao, yammer, mix, yummly, odnoklassniki, pocket</i> </div>
          </p>
          </div>
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'share_text' ); ?>"><strong><?php _e( 'Custom Share Text ', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'custom_share_link' ); ?>"><strong><?php _e( 'Custom Share Link ', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'alignment' ); ?>"><strong><?php _e( 'Alignment', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
                    <input type="radio" name="<?php echo $this -> get_field_name( 'alignment' ); ?>" <?php
                    if ( $alignment == 'left' ) {
                         echo "checked='checked'";
                    }
                    ?> value="left">Left
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'widget_color' ); ?>"><strong><?php _e( 'Widget Background Color ', APSS_TEXT_DOMAIN ); ?></strong></label>
               </p>
               <p>
     ...
     public function widget( $args, $instance ){
          ...
          if ( $widget_flag != '1' ) {
               ...
               echo do_shortcode( "[apss_share theme='$theme' counter='$counter' total_counter='$counter' networks='$networks' share_text='$share_text' custom_share_link='$custom_share_link' alignment='$alignment']" );
               ?>
