...
<div class="apss-tab-contents apss-resources" id="tab-apss-resources" style='display:none' >
     <div class="about-social-pro-wrapper clearfix">
          <div class="social-more-wrap clearfix">
               <div class="about-title">More WordPress Resources</div>
               <div class="about-content">
                    <p> Themes Compatible with the Plugin :</p>

                    <p>AccessPress Social PRO works best with every WordPress theme. It's even more remarkable when used with popular themes like VMagazine and AccessPress Parallax.</p>
