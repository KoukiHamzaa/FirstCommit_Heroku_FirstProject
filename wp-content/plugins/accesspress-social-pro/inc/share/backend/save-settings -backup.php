...
if ( $_POST[ 'action' ] == 'apss_save_options' ) {
    ...
    $apss_share_settings[ 'icon_color' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'icon_color' ] );
    $apss_share_settings[ 'text_color' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'text_color' ] );
    $apss_share_settings[ 'background_color' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'background_color' ] );
    $apss_share_settings[ 'hover_color' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'hover_color' ] );
    $apss_share_settings[ 'custom_css' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'custom_css' ] );
    
    $apss_share_settings[ 'share_prepend_text' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'share_prepend_text' ] );
    $apss_share_settings[ 'share_append_text' ] = stripslashes_deep( $_POST[ 'apss_share_settings' ][ 'share_append_text' ] );
    ...
    wp_redirect( admin_url() . 'admin.php?page=apss-share-pro'. $hashtag );
    exit;
