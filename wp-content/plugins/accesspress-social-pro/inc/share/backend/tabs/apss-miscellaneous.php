...
<div class="apss-tab-contents apss-miscellaneous" id="tab-apss-miscellaneous" style='display:none'>
     ...
     <div class="apss-row-odd">
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    ...
                    <p class="description"> <?php _e( 'Please enter you twitter username here. This will help extract your twitter share count.', APSS_TEXT_DOMAIN ) ?> </p>
               </div>
          </div>
     </div>
     ...
     <div class="apss-row-odd">
          ...
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type='text' id="apss_facebook_app_id" name='apss_share_settings[api_configuration][facebook][app_id]' value="<?php
          ...
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type='text' id="apss_facebook_app_secret" name='apss_share_settings[api_configuration][facebook][app_secret]' value="<?php
     ...
     <div class="apss-row-odd">
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type="radio" id='dialog_box_options_blank' name="apss_share_settings[dialog_box_options]" value="0" <?php
                    ...
                    <label class="">
                         <input type="radio" id='dialog_box_options_new' name="apss_share_settings[dialog_box_options]" value="1" <?php
                    ...
                    <label class="">
                         <input type="radio" id='dialog_box_options_3' name="apss_share_settings[dialog_box_options]" value="2" <?php
                    ...
                    <p class="description"> <?php _e( 'Select how you wish your share link to be opened in the windows', APSS_TEXT_DOMAIN ) ?> </p>
               </div>
          </div>
     </div>
     <div class="apss-row-even">
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type="radio" id='disable_whatsapp_button_no' name="apss_share_settings[disable_whatsapp_in_desktop]" value="0" <?php
                    ...
                    <label class="">
                         <input type="radio" id='disable_whatsapp_button_yes' name="apss_share_settings[disable_whatsapp_in_desktop]" value="1" <?php
                    ...
                    <p class="description"> <?php _e( "Select 'Yes' to disable WhatsApp share in non mobile devices", APSS_TEXT_DOMAIN ) ?> </p>
               </div>
          </div>
     </div>
     <div class="apss-row-odd">
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type="radio" id='disable_viber_button_no' name="apss_share_settings[disable_viber_in_desktop]" value="0" <?php
                    ...
                    <label class="">
                         <input type="radio" id='disable_viber_button_yes' name="apss_share_settings[disable_viber_in_desktop]" value="1" <?php
                    ...
                    <p class="description"> <?php _e( "Select 'Yes' to disable Viber share in non mobile devices", APSS_TEXT_DOMAIN ) ?> </p>
               </div>
          </div>
     </div>
     <div class="apss-row-even">
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type="radio" id='disable_sms_button_no' name="apss_share_settings[disable_sms_in_desktop]" value="0" <?php
                    ...
                    <label class="">
                         <input type="radio" id='disable_sms_button_yes' name="apss_share_settings[disable_sms_in_desktop]" value="1" <?php
                    ...
                    <p class="description"> <?php _e( "Select 'Yes' to disable SMS share in non mobile devices", APSS_TEXT_DOMAIN ) ?> </p>
               </div>
          </div>
     </div>
     <div class="apss-row-odd">
          <div class="apss-general-div">
               ...
               <div class="apss-option-value">
                    <label class="">
                         <input type="radio" id='disable_messenger_button_no' name="apss_share_settings[disable_messenger_in_desktop]" value="0" <?php
                    ...
                    <label class="">
                         <input type="radio" id='disable_messenger_button_yes' name="apss_share_settings[disable_messenger_in_desktop]" value="1" <?php
                    ...
                    <p class="description"> <?php _e( "Select 'Yes' to disable Messenger share in non mobile devices", APSS_TEXT_DOMAIN ) ?> </p>
               </div>
          </div>
     </div>
</div>