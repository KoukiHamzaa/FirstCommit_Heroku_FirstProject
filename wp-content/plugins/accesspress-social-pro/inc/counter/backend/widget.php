...
class APSC_PRO_Widget extends WP_Widget{
     ...
     function __construct(){
          parent::__construct(
                  'aps_widget', // Base ID
                  __( 'AccessPress Social Counter Pro', 'ap-social-pro' ), // Name
                  array( 'description' => __( 'AccessPress Social Counter Pro Widget', 'ap-social-pro' ) ) // Args
          );
     }
     ...
     public function widget( $args, $instance ){
          ...
          echo do_shortcode( '[aps-counter-pro' . $theme_atts . $profiles_atts . $counter_format_atts . $animation_atts . ']' );
     ...
     public function form( $instance ){
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'title' ); ?>"><strong><?php _e( 'Title', 'ap-social-pro' ); ?></strong></label>
               </p>
               <p>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'profiles' ); ?>"><strong><?php _e( 'Social Profiles', 'ap-social-pro' ); ?></strong></label>
               </p>
               <p>
                    <textarea cols='4' class="widefat" id="<?php echo $this -> get_field_id( 'profiles' ) ?>" name="<?php echo $this -> get_field_name( 'profiles' ) ?>" rows="5"><?php echo $profiles; ?></textarea>
               </p>
               <div class='apss-note'><i><strong>Available parameters are </strong>: facebook, twitter, instagram, google-plus, soundcloud, dribbble, youtube, steam, vimeo, pinterest, forrst, vk, flickr, behance, github, envato, posts, comments, spotify, twitch, feedly, slideshare, foursquare, delicious, weheartit </i> </div>
               <span class="apsc-option-note"><i><?php _e( 'Please enter comma separated profiles names. Profiles from plugin social profiles will be shown if kept blank', 'ap-social-pro' ); ?></i></span>
          </p>
          </div>
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'theme' ); ?>"><strong><?php _e( 'Theme', 'ap-social-pro' ); ?></strong></label>
               </p>
               <p>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'animation' ); ?>"><strong><?php _e( 'Animation', 'ap-social-pro' ); ?></strong></label>
               </p>
               <p>
                    <select class="widefat" id="<?php echo $this -> get_field_id( 'animation' ); ?>" name="<?php echo $this -> get_field_name( 'animation' ); ?>">
                         <option value="default" <?php selected( $animation, 'default' ); ?>><?php _e( 'Default', 'ap-social-pro' ); ?></option>
          ...
          <div>
               <p>
                    <label for="<?php echo $this -> get_field_id( 'counter-format' ); ?>"><strong><?php _e( 'Counter Format', 'ap-social-pro' ); ?></strong></label>
               </p>
               <p>
                    <select class="widefat" id="<?php echo $this -> get_field_id( 'counter-format' ); ?>" name="<?php echo $this -> get_field_name( 'counter_format' ); ?>">
                         <option value=""><?php _e( 'Choose Count Format', 'ap-social-pro' ); ?></option>
