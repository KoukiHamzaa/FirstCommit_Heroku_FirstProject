<div class="apss-tab-contents apss-how-to-use" id="tab-apss-how-to-use" >
     ...
     <p>
          Basically there are five main settings tabs that will help you to setup the plugin to work properly.
     </p>
     <dl>
          <dt>
          ...
          <dd>
               <p>
                    In this tab you can choose which social media icons you want to show in the frontend. Here you can order the apperance of the social icons simply by drag and drop of each social media icons.
               </p>
          </dd>
          <dt>
          ...
          <dd>
               <p>
                    In this tab you can select the options where you want to display these social media shares. Supports custom post types as well as custom taxonomies. Pinterest pinit button for each images can be enabled from here as well.
               </p>
          </dd>
          <dt>
          ...
          <dd>
               <p>
                    In this tab you can choose the options to display the share icons below the content, above the content or you can choose an options to display in both below and above content. Also you can choose the theme from the pre available 10 themes. You can enable or disable the popup share at page load from this section.
               </p>
          </dd>
          <dt>
               <strong>Floating options</strong>
          </dt>
          <dd>
               <p>In this tab you can set the options for display of the floating sidebar. You can choose the theme from pre available 4 themes. You can choose the floating options from available options - Left Middle, Right Middle, Bottom Left, Bottom Right. You can enable or disable the share count specifically for floating sidebar from here.
               </p>
          </dd>
          <dt><strong>Miscellaneous settings</strong></dt>
          <dd>
               <p>In this tab you can do the additions settings for the plugin.
               <ul class="how-list">
               ...
               <ul class="how-list">
                    ...
                    <li><i class="fa fa-check"></i>Available shortcode parameters:
                         <ul>
                              ...
                              <li><i class="fa fa-check"></i> eg.<code>[apss_share theme='2' counter='1' total_counter='1' networks='facebook, twitter, linkedin' share_text='share it' custom_share_link='https://www.google.com' alignment='center']</code> </li>
          ...
          <dd>
               <p>
                    You can use <code>[apss_count]</code> shortcode to display the share counts number only in the content using shortcode. You can wrap that number in your reqired html tags and use it as per your need. The share count displayed will be the sum of entered network attributes.
               <ul class="how-list">
                    <li><i class="fa fa-check"></i>Example 2: <code>[apss_count]</code></li>
                    <li><i class="fa fa-check"></i>Available shortcode Parameters
                         <ul>
