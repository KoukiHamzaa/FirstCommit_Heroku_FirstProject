...
$default_count = (isset( $apsc_settings[ 'social_profile' ][ 'dribbble' ][ 'default_count' ] ) && $apsc_settings[ 'social_profile' ][ 'dribbble' ][ 'default_count' ] != '') ? $apsc_settings[ 'social_profile' ][ 'dribbble' ][ 'default_count' ] : 0;
...
if ( false === $dribbble_count ) {
     ...
     if ( isset( $apsc_settings[ 'social_profile' ][ 'dribbble' ][ 'access_token' ] ) && $apsc_settings[ 'social_profile' ][ 'dribbble' ][ 'access_token' ] != '' ) {
          ...
          //$api_url = 'https://api.dribbble.com/v1/users/' . $username.'/?access_token='.$access_token; This one is depricated
